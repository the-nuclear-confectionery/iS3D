...
int main()
{
  	printf("\nLoading particle info from Smash Box pdg.dat\n");

  	particle_info * particle = new particle_info[Maxparticle];		// particle info struct



  	// read resonances in pdg smash box file
  	//**************************************************************/|
	int N_resonances = read_resonances_list_smash_box(particle);	//
	//**************************************************************/|
	...
	c0_table_df14.open("smash_box/c0.dat", ios::out);
	c1_table_df14.open("smash_box/c1.dat", ios::out);
	c2_table_df14.open("smash_box/c2.dat", ios::out);
	c3_table_df14.open("smash_box/c3.dat", ios::out);
	c4_table_df14.open("smash_box/c4.dat", ios::out);
	...
	G_table_dfce.open("smash_box/G.dat", ios::out);
	F_table_dfce.open("smash_box/F.dat", ios::out);
	betabulk_table_dfce.open("smash_box/betabulk.dat", ios::out);
	betaV_table_dfce.open("smash_box/betaV.dat", ios::out);
	betapi_table_dfce.open("smash_box/betapi.dat", ios::out);
