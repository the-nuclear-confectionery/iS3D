...
int main()
{
  	printf("\nLoading particle info from pdg.dat (check that only 1 blank line at end of file)\n");
	...
	c0_table_df14.open("urqmd/c0.dat", ios::out);
	c1_table_df14.open("urqmd/c1.dat", ios::out);
	c2_table_df14.open("urqmd/c2.dat", ios::out);
	c3_table_df14.open("urqmd/c3.dat", ios::out);
	c4_table_df14.open("urqmd/c4.dat", ios::out);
	...
	G_table_dfce.open("urqmd/G.dat", ios::out);
	F_table_dfce.open("urqmd/F.dat", ios::out);
	betabulk_table_dfce.open("urqmd/betabulk.dat", ios::out);
	betaV_table_dfce.open("urqmd/betaV.dat", ios::out);
	betapi_table_dfce.open("urqmd/betapi.dat", ios::out);
