...
double GaussThermal(double thermal_integrand(double pbar, double mbar, double alphaB, double baryon, double alphaQ, double charge, double alphaS, double strange, double sign), double * pbar_root, double * pbar_weight, int pbar_pts, double mbar, double alphaB, double baryon, double alphaQ, double charge, double alphaS, double strange, double sign);
